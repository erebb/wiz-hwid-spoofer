...
const TextEditor::Palette& TextEditor::GetVSCodePallete()
{
	const static Palette p = { {
			0xffffffff,	// Default //
			0xffc086c8,	// Keyword	//
			0xffa8ceb5,	// Number//
			0xff7890ce,	// String//
			0xff7890ce, // Char literal//
			0xffffffff, // Punctuation//
			0xff7f0000,	// Preprocessor//
			0xffaaaaaa, // Identifier
			0xff9ddcdc, // Known identifier
			0xffc040a0, // Preproc identifier
...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::Lua()
{
	...
	if (!inited)
	{
		...
		static const char* const identifiers[] = {
			...
			"coroutine", "table", "io", "os", "string", "utf8", "bit32", "math", "debug", "package", "Vector3", "World", "world", "GetPlayer", "new", "Sleep", "sleep", "Log"
		};
